 ...
 * (GenCodeChecksum:7872ee7a4c0127436eb807d50fd5a6a4)
 */
...
class CRM_CivicrmMembershipPeriod_DAO_MembershipPeriod extends CRM_Core_DAO {
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      'UI_membership_period' => [
        'name' => 'UI_membership_period',
        'field' => [
          0 => 'membership_id',
          1 => 'start_date',
          2 => 'end_date',
        ...
        'localizable' => FALSE,
        'unique' => TRUE,
        'sig' => 'civicrm_membership_period::1::membership_id::start_date::end_date',
      ],
    ];
